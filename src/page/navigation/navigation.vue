...
<div class="tables">
  ...
  <div class="add-dialog">
    <el-dialog title="导航添加" :visible.sync="addDialog">
      <el-form>
        ...
        <el-form-item label="所属分组" :label-width="formLabelWidth">
          <el-input v-model="addForm.parent_id" auto-complete="off" placeholder="请输入内容"></el-input>
        </el-form-item>
  ...
  <div class="edit-dialog">
    <el-dialog title="导航编辑" :visible.sync="editDialog">
      <el-form :model="editForm">
        ...
        <el-form-item label="所属分组" :label-width="formLabelWidth">
          <el-select v-model="editForm.parent_id" placeholder="请选择分组">
            <el-option label="文本" value="1"></el-option>
            <el-option label="字符" value="2"></el-option>
            <el-option label="整形" value="3"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
