...
<div class="tables">
  ...
  <div class="main-table">
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="tableSelectionChange" border>
      ...
      <el-table-column prop="up_ip" label="ip">
      </el-table-column>
    ...
    <el-dialog title="管理员添加" :visible.sync="addDialog">
      <el-form>
        ...
        <el-form-item label="密码" :label-width="formLabelWidth">
          <el-input v-model="addForm.pass" auto-complete="off" placeholder="请输入内容"></el-input>
        </el-form-item>
        ...
        <el-form-item label="分组" :label-width="formLabelWidth">
          <el-select v-model="addForm.group" placeholder="请选择分组">
  ...
  <div class="edit-dialog">
    <el-dialog title="管理员编辑" :visible.sync="editDialog">
      <el-form :model="editForm">
        <el-form-item label="用户名" :label-width="formLabelWidth">
          <el-input v-model="editForm.name" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="密码" :label-width="formLabelWidth">
          <el-input v-model="editForm.pass" auto-complete="off" type="password"></el-input>
        </el-form-item>
        <el-form-item label="状态" :label-width="formLabelWidth">
